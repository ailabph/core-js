...
describe("ohlc_tool spec",()=> {
    ...
    it("ohlc_tool getOpen", () => {
        ...
        const open = eth_ohlc_tool.getOpen(events,true);
        assert.equal(open,5);
    });
    ...
    it("ohlc_tool getClose", () => {
        ...
        const close = eth_ohlc_tool.getClose(events,true);
    ...
    it("ohlc_tool getHigh", () => {
        ...
        const high = eth_ohlc_tool.getHigh(events,true);
    ...
    it("ohlc_tool getLow", () => {
        ...
        const low = eth_ohlc_tool.getLow(events,true);
        assert.equal(low,5);
    });
    ...
    it("ohlc_tool getSellVolume", () => {
        ...
        events.push(newEvent);
        const totalSellVolume = eth_ohlc_tool.getSellVolume(events,true);
    ...
    it("ohlc_tool getBuyVolume", () => {
        ...
        newEvent.type = TRADE_TYPE.SELL;
        events.push(newEvent);
        const totalBuyVolume = eth_ohlc_tool.getBuyVolume(events,true);
    ...
    it("ohlc_tool getTotalVolume", () => {
        ...
        const result = eth_ohlc_tool.getTotalVolume(events,true);
