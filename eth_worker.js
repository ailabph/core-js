...
class eth_worker {
    ...
    //endregion
    //region TRADE
    static async swapExactETHForTokens(bnb_amount) {
    ...
    static async swapExactTokensForETH(token_amount) {
        ...
        const dex_contract = await new Web3Client.eth.Contract(eth_config_1.eth_config.getDexAbi(), eth_config_1.eth_config.getDexContract());
        let data = dex_contract.methods.swapExactTokensForETH(token_value, [eth_config_1.eth_config.getEthContract(), eth_config_1.eth_config.getTokenContract()], eth_config_1.eth_config.getHotWalletAddress(), web3_1.default.utils.toHex(Math.round(Date.now() / 1000) + 60 * 20)).encodeABI();
        let _nonce = await Web3Client.eth.getTransactionCount(eth_config_1.eth_config.getHotWalletAddress());
        console.log(`nonce found:${_nonce}`);
