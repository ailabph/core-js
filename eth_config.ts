...
export class eth_config {
    ...
    //region BUSD
    public static getBusdContract():string{
        return config.getCustomOption("BUSD_CONTRACT",true) as string;
    }
    public static getBusdSymbol():string{
        return config.getCustomOption("BUSD_SYMBOL",true) as string;
    }
    public static getBusdDecimal():number{
        return tools.parseIntSimple(config.getCustomOption("BUSD_DECIMAL",true));
    }
    //endregion END BUSD
    ...
    public static getEthDecimal(): number {
        const eth_decimal = config.getCustomOption("ETH_DECIMAL", true) as number;
        return tools.parseInt({val:eth_decimal,name:"eth_decimal",strict:true});
    }
    ...
    public static getTokenDecimal(): number {
        let token_decimal = config.getCustomOption("TOKEN_TO_TRACK_DECIMAL", true);
        return tools.parseInt({val:token_decimal,name:"token_decimal",strict:true});
    }
    ...
    public static getPancakePairAbi(): any[]{
    ...
    public static getTokenBnbPairContract():string{
        return config.getCustomOption("TOKEN_BNB_PAIR_CONTRACT",true) as string;
    }
    public static getTokenUsdPairContract():string{
        return config.getCustomOption("TOKEN_USD_PAIR_CONTRACT",true) as string;
    }
    public static getPancakeFactoryAbi():any[]{
    ...
    public static getPancakeFactoryContract():string{
        return config.getCustomOption("PANCAKE_FACTORY_CONTRACT",true) as string;
    }
    public static getBnbUsdPairContract():string{
        return config.getCustomOption("BNB_USD_PAIR_CONTRACT",true) as string;
    }
    public static getSyncTopicSig():string{
        return config.getCustomOption("SYNC_TOPIC_SIG",true) as string;
    }
    public static getTradingPairs():string[]{
        let pairs:string[] = [];
        pairs.push(eth_config.getTokenBnbPairContract());
        const tokenUsdPair = this.getTokenUsdPairContract();
        if(!tools.isEmpty(tokenUsdPair)){
